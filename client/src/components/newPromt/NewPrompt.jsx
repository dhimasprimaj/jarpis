...
const SYSTEM_PROMPT = `Anda adalah AI Chef, asisten memasak profesional yang HANYA fokus pada dunia kuliner. 
...
// Daftar kata kunci untuk validasi input
const KULINER_KEYWORDS = [
  ...
  "garam", "gula", "minyak", "santan", "susu",
  
  // Teknik & Metode
  "goreng", "rebus", "kukus", "panggang", "tumis", "bakar", "blender", "mixer",
  "potong", "iris", "cincang", "aduk", "masakan",
  
  // Peralatan
  "panci", "wajan", "kompor", "oven", "pisau", "spatula", "blender", "mixer",
  "talenan", "sendok", "garpu",
  
  // Jenis Makanan
  "nasi", "mie", "roti", "kue", "sup", "soto", "sate", "rendang", "gulai",
  "sambal", "sayur", "gorengan", "jus", "teh", "kopi",
  
  // Nutrisi & Kesehatan
  "nutrisi", "gizi", "vitamin", "mineral", "protein", "karbohidrat", "lemak",
  
  // Budaya & Sejarah
  "tradisional", "khas", "warisan", "budaya", "sejarah", "asal", "daerah"
];

const REJECTION_RESPONSES = [
  "Maaf Chef, saya hanya bisa membahas hal-hal seputar dunia kuliner! 🍳 Bagaimana kalau kita diskusi tentang resep atau teknik memasak saja? 😊",
  ...
  "Chef hanya bisa membantu soal kuliner nih! 🍜 Tanya saja seputar makanan, minuman, atau teknik memasak ya! 🥪",
  "Sebagai AI Chef, fokus saya cuma di dapur! 👨‍🍳 Ayo kita bahas soal masakan atau minuman saja! 🍹"
];
...
const NewPrompt = ({ data }) => {
  ...
  const isKulinerRelated = (text) => {
    ...
    return KULINER_KEYWORDS.some(keyword => 
